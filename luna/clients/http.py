...
import requests
from werkzeug.utils import string_types
...
class HTTPClient(requests.Session):
    ...
    def __init__(self, host='127.0.0.1', port=80, token=None, auto_decode=False, **kwargs):
    ...
    def request(self, method, url, **kwargs):
        ...
        try:
            return self.json_pretty(self.ret.json())
        except:
            return self.ret.text

    def json_pretty(self, data):
